...
public class BosActivity extends BaseActivity {
    ...
    private void init() {
        ...
        bosListener = new OnBosListener() {
            ...
            public void onPutObjectCallback(BosPutObjectResponse response) {
                ToastUtils.showToastCentre(BosActivity.this, response.getMessage());
            }
            ...
            public void onGetObjectCallback(final BosGetObjectResponse response) {
                ...
                ToastUtils.showToastCentre(BosActivity.this, getString(R.string.save_picture));
                new Thread() {
                    @Override
                    public void run() {
                        saveObject(response);
    ...
    private void openAlbum() {
        ...
        try {
            ...
            ToastUtils.showToastCentre(this, getString(R.string.open_album_failed));
        }
    }
    ...
    private void handleImage(Intent data) {
        ...
        if (TextUtils.isEmpty(imagePath)) {
            ToastUtils.showToastCentre(this, getString(R.string.not_select_picture));
            return;
        }
        ...
        switch (requestCode) {
            case GRANTED:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ToastUtils.showToastCentre(this, getString(R.string.not_granted_album_permission));
                }
                break;
    ...
    static class BosHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ToastUtils.showToastCentre(bosActivity.get(), (String) msg.obj);
        }
    }
