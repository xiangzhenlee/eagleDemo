...
import com.yushan.eagledemo.track.dialog.TrackAnalysisDialog;
import com.yushan.eagledemo.track.dialog.TrackAnalysisInfoLayout;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_activity_options:
                Intent intent = new Intent(TrackQueryActivity.this, TrackQueryOptionsActivity.class);
        ...
        mTrackListener = new OnTrackListener() {
            ...
            public void onHistoryTrackCallback(HistoryTrackResponse response) {
                ...
                if (StatusCodes.SUCCESS != response.getStatus()) {
                    ToastUtils.showToastCentre(TrackQueryActivity.this, response.getMessage());
                } else if (0 == total) {
                    ToastUtils.showToastCentre(TrackQueryActivity.this, getString(R.string.no_track_data));
                } else {
