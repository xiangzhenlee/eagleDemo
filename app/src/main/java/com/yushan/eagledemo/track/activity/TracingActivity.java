...
import com.yushan.eagledemo.track.model.CurrentLocation;
import com.yushan.eagledemo.track.receiver.TrackReceiver;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_activity_options:
                Intent intent = new Intent(TracingActivity.this, TracingOptionsActivity.class);
    ...
    private void initListener() {
        ...
        traceListener = new OnTraceListener() {
            ...
            public void onBindServiceCallback(int errorNo, String message) {
                ToastUtils.showToastCentre(TracingActivity.this,
            ...
            public void onPushCallback(byte messageType, PushMessage pushMessage) {
                if (messageType < 0x03 || messageType > 0x04) {
                    ToastUtils.showToastCentre(TracingActivity.this, pushMessage.getMessage());
                    return;
                }
