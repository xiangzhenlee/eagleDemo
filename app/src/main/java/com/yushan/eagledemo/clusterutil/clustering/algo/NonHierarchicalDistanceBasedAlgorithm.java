...
package com.yushan.eagledemo.clusterutil.clustering.algo;
...
import com.yushan.eagledemo.clusterutil.projection.Bounds;
...
import com.yushan.eagledemo.clusterutil.quadtree.PointQuadTree;
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        synchronized(mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.yushan.eagledemo.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.yushan.eagledemo.clusterutil.clustering.algo
